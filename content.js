window.addEventListener('load', function () {
    ...
    if (window.location.href.includes("dylanp369")) {
        ...
        if (window.location.href.includes("snake")) {
            var badBoy = this.document.createElement("H1");
    ...
    if (window.location.href.includes("venkat")) {
        ...
        newString = "";
        for (var i = 0; i < allHisStuff.length; i++) {
            if (allHisStuff[i].toLowerCase().includes("venkat") || allHisStuff[i].toLowerCase().includes("video") || allHisStuff[i].toLowerCase().includes("game") || allHisStuff[i].toLowerCase().includes("godly")) {
                newString += ('<smart class="crazy" style="color: chartreuse;">') + randomWordList[Math.floor(Math.random() * randomWordList.length)] + ' </smart>'
            } else {
                newString += allHisStuff[i] + " ";
            }
    ...
    if (window.location.href.includes("wyatt")) {
        var allHisStuff = [];
        allHisStuff = document.body.innerHTML.split(" ");
        newString = "";
        for (var i = 0; i < allHisStuff.length; i++) {
            if (allHisStuff[i].toLowerCase().includes("teenager") || allHisStuff[i].toLowerCase().includes("sachitt") || allHisStuff[i].toLowerCase().includes("wyatt") || allHisStuff[i].toLowerCase().includes("godly")) {
                newString += ('<smart class="crazy" style="color: chartreuse;">') + randomWordList[Math.floor(Math.random() * randomWordList.length)] + ' </smart>'
            } else {
                newString += allHisStuff[i] + " ";
            }
        }
        if (!this.window.location.href.includes("other")) {
            document.body.innerHTML = newString;
        }
        if (this.window.location.href.includes("other")) {
            var meme = this.document.createElement("p");
...
var randomWordList = [
    ...
    "Audrey", "Miles", "Sanjit", "Sanjit", "Sanjit", "Sanjit", "Sanjit", "Sanjit", "Darien", "Arman", "Yui", "Anjali",
    "Anjali", "Ian", "Dan", "Dominic", "Jordan", "Ritesh", "Ritesh", "VenkatSai Baba",
    "VenkatSai Baba", "VenkatSai Baba", "VenkatSai Baba", "VenkatSai Baba", "VenkatSai Baba",
    "VenkatSai Baba", "VenkatSai Baba", "VenkatSai Baba", "VenkatSai Baba", "VenkatSai Baba",
    "Vicky", "Daniel", "Waytt", "Waytt", "Waytt", "Waytt", "Elyssa", "Aneesh Babu",
    "Aneesh Babu", "Aneesh Babu", "Aneesh Babu", "Aneesh Babu", "Aneesh Babu", "Eddie",
    "Trinh", "Grace? Who dat", "Grace? Who dat", "Grace? Who dat", "Grace? Who dat",
    "Ken", "Aly", "Kianna", "Katty", "Aayushi Mendes", "Aayushi Mendes", "Aayushi Mendes",
    "Aayushi Mendes", "Aayushi Mendes", "Aayushi Mendes", "Blake", "Jonathan", "Jonathan", 
    "Jonathan", "Jonathan", "Jonathan", "Sivaram Babu", "Sivaram Babu", "Sivaram Babu", "Sivaram Babu",
    "Sivaram Babu", "Agni gurji", "Agni gurji", "Agni gurji", "Agni gurji", "Drew", "Kodi", "Ryan", "Anjana",
    "Dylan",
    "Audrey", "Miles", "Sanjit", "Sanjit", "Sanjit", "Sanjit", "Sanjit", "Sanjit", "Darien", "Arman", "Yui", "Anjali",
    "Anjali", "Ian", "Dan", "Dominic", "Jordan", "Ritesh", "Ritesh", "VenkatSai Baba",
    "VenkatSai Baba", "VenkatSai Baba", "VenkatSai Baba", "VenkatSai Baba", "VenkatSai Baba",
